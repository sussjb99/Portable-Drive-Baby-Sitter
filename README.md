...
This software is designed to be small in size and should be installed and run directly from your storage external devices.

This software is was written in C++, Powershell, and the bat scripting language.
